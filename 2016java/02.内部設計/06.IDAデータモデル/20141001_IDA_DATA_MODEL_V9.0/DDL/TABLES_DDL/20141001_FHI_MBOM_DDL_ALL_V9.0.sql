...
CREATE GLOBAL TEMPORARY TABLE "GT007001" (
		"TRIAL_CLASS" CHAR(1) NOT NULL, 
...
CREATE TABLE "TB002001" (
		...
		"APPLY_CHG_DESCRIPTION" VARCHAR(300) NOT NULL, 
...
CREATE TABLE "TB004001" (
		...
		"SUPPLIER_CODE" CHAR(4) NOT NULL, 
		"PROD_BASE_CODE" CHAR(1) NOT NULL, 
		"DATA_CHECK_RESULT" VARCHAR(36) NOT NULL, 
		"REPR_OF_MAIN_ECS_NO" CHAR(15) NOT NULL, 
