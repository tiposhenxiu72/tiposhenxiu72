...
public class ConferenceController extends PortfolioController {
	...
	public Resource exportExcel(@Validated @ModelAttribute(FORM_NAME) final GyConferenceForm form,
	...
	public String importExcel(@Validated @ModelAttribute(FORM_NAME) final GyConferenceForm form,
	...
	public PortfolioExcelHelper getExcelHelper() {
		return new ConferenceExcelHelper();
	}
}
