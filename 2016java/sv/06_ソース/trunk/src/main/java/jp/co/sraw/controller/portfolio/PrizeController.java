...
public class PrizeController extends PortfolioController {
	...
	public Resource exportExcel(@Validated @ModelAttribute(FORM_NAME) final GyPrizeForm form,
	...
	public String importExcel(@Validated @ModelAttribute(FORM_NAME) final GyPrizeForm form,
