...
public class SocietyController extends PortfolioController {
	...
	public Resource exportExcel(@Validated @ModelAttribute(FORM_NAME) final GySocietyForm form,
	...
	public String importExcel(@Validated @ModelAttribute(FORM_NAME) final GySocietyForm form,
