...
public class OthersController extends PortfolioController {
	 ...
	 */
	@RequestMapping({ "", "/", "/list" })
	public String index(@ModelAttribute(FORM_NAME) GyOthersForm form, Model model, Locale locale) {
	...
	public Resource exportExcel(@Validated @ModelAttribute(FORM_NAME) final GyOthersForm form,
	...
	public String importExcel(@Validated @ModelAttribute(FORM_NAME) final GyOthersForm form,
