...
public class CompetitionController extends PortfolioController {
	...
	public Resource exportExcel(@Validated @ModelAttribute(FORM_NAME) final GyCompetitionForm form,
	...
	public String importExcel(@Validated @ModelAttribute(FORM_NAME) final GyCompetitionForm form,
	...
	public PortfolioExcelHelper getExcelHelper() {
		return new CompetitionExcelHelper();
	}
}
