...
public class DegreeController extends PortfolioController {
	...
	public Resource exportExcel(@Validated @ModelAttribute(FORM_NAME) final GyDegreeForm form,
	...
	public String importExcel(@Validated @ModelAttribute(FORM_NAME) final GyDegreeForm form,
