...
public class AcademicController extends PortfolioController {
	...
	public Resource exportExcel(@Validated @ModelAttribute(FORM_NAME) final GyAcademicForm form,
	...
	public String importExcel(@Validated @ModelAttribute(FORM_NAME) final GyAcademicForm form,
	...
	public PortfolioExcelHelper getExcelHelper() {
		return new AcademicExcelHelper();
	}
}
