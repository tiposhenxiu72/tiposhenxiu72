...
public class PatentController extends PortfolioController {
	...
	public Resource exportExcel(@Validated @ModelAttribute(FORM_NAME) final GyPatentForm form,
	...
	public String importExcel(@Validated @ModelAttribute(FORM_NAME) final GyPatentForm form,
