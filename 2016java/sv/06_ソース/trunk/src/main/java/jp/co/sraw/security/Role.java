...
public enum Role {
	...
	ROLE_USER1("ROLE_USER1", 130), // 個人ユーザ（若手研究者D）
	ROLE_USER2("ROLE_USER2", 120), // 個人ユーザ（若手研究者PD）
	ROLE_USER3("ROLE_USER3", 110), // 個人ユーザ（その他一般教職員）
	ROLE_USER4("ROLE_USER4", 100), // 個人ユーザ（相談員）
