...
public class ResearchAreaController extends PortfolioController {
	...
	public Resource exportExcel(@Validated @ModelAttribute(FORM_NAME) final GyResearchAreaForm form,
	...
	public String importExcel(@Validated @ModelAttribute(FORM_NAME) final GyResearchAreaForm form,
	...
	public PortfolioExcelHelper getExcelHelper() {
		return new ResearchAreaExcelHelper();
	}
}
